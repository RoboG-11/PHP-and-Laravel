 ...
 * @author PEDRO PABLO
 */
public class FabricaConcreta_MenuGourmet extends FabricaAbstractaMenu {
    private MenuGourmet menuGourmet;
        ...
        if (tipoVino == 1){
            ...
            switch (variedadMenuSeleccionado) {
                ...
                case 3:
                    ...
                    segundoPlato = "Pierna de cerdo al horno"; postre = "Strudel del manzana"; 
            ...
            menuGourmet = new MenuGourmet (antiPasto1, antiPasto2, antiPasto3,
            primerPlato, segundoPlato, postre, vino);
        }
        if (tipoVino == 2){
            menuGourmet = new MenuGourmet ("Queso provoleta", "Crostini mixtos", "Lasagna frita",
            "Pasta alla carbonara", "Milanera de ternera", "Gelato", "Vino tinto joven");
        }
        if (tipoVino == 3){
            menuGourmet = new MenuGourmet ("Mixto de quesos frescos", "Carpacho de salmón", "Bruschetta",
