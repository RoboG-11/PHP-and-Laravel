...
class ReservacionDeVuelo
{
    ...
    public function __construct($itinerarioVuelo, $datosPasajero, $datosPago)
    {
        ...
        if ($this->datosPago != null) {
            $this->statusReservacion = "OK";
        } else {
            $this->statusReservacion = "PENDIENTE DE PAGO";
        }
    }
    ...
    /**
     * Get the value of statusReservacion
     */
    public function getStatusReservacion()
    {
        return $this->statusReservacion;
    }
}
